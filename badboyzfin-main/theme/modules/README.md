<div align="center">
<img src="https://github.com/JamsRepos/badboyzfin/blob/main/assets/logo.png?raw=true" alt="Logo" width="125"/>
...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/badboyzfin@latest/theme/modules/<name>.css");
```
