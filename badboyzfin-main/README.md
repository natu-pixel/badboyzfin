...
[![Download Hits](https://data.jsdelivr.com/v1/package/gh/JamsRepos/badboyzfin/badge)](https://www.jsdelivr.com/package/gh/JamsRepos/badboyzfin)

( <a href="https://github.com/JamsRepos/badboyzfin#ℹ%EF%B8%8F-welcome">About</a> - <a href="https://github.com/JamsRepos/badboyzfin#-screenshots">Screenshots</a> )
...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/badboyzfin@latest/theme/complete.css");
```
...
```css
@import url("https://cdn.jsdelivr.net/gh/JamsRepos/badboyzfin@latest/theme/base.css");
```
